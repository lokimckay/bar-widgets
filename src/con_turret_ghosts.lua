...
--[[-------------------------------------------------------------------
	...
	References
		* Unit Nano Ghost by Tom Fyuri - https://github.com/TomFyuri/BAR-Widgets/blob/main/unit_show_nanos.lua
		* Ghost Radar GL4 by very_bad_soldier, Floris (GL4) - https://github.com/beyond-all-reason/Beyond-All-Reason/blob/master/luaui/Widgets/unit_ghostradar_gl4.lua
